...
export const LoggedIn = () => {
  ...
  return (
    <div className="logged-in">
      <button onClick={handleNavigate} className="logged-in__favourites">
        <svg
          width="18"
          height="17"
          viewBox="0 0 18 17"
      ...
      <Link to="/cart" className="logged-in__basket">
        <svg
          width="18"
          height="18"
          viewBox="0 0 18 18"
      ...
      <ProfileSettings openState={openSettings} />
    </div>
  );
};
